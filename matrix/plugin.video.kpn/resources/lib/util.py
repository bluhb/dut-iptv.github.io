...
import datetime, sys, xbmc
from resources.lib.base import gui, inputstream, settings, uaparser
from resources.lib.base.constants import DEFAULT_USER_AGENT
from resources.lib.base.language import _
from resources.lib.base.session import Session
from resources.lib.base.util import check_key, convert_datetime_timezone, date_to_nl_dag, date_to_nl_maand, load_file, load_profile, query_epg, query_settings
...
def service_timer(timer):
    if timer == 'daily':
        ...
        from resources.lib.base.util import is_file_older_than_x_days
